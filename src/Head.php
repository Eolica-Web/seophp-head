...
use Seo\Head\Hooks\TitleAddedHookContext;
...
final class Head
{
    ...
    private readonly HeadHooks $hooks;

    private function __construct()
    {
        $this->tags = HeadTags::empty();

        $this->hooks = new HeadHooks();
    }
    ...
    public function title(string $value): self
    {
        ...
        $context = new TitleAddedHookContext($this, $value);

        $this->hooks->call(HeadHook::TitleAdded->value, $context);
